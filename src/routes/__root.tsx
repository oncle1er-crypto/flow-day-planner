...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "App intelligente de gestion de tâches, rappels, priorités, habitudes et objectifs. Pensée mobile-first." },
      { property: "og:title", content: "Flow Day Planner — Organisez vos journées" },
      { property: "og:description", content: "App intelligente de gestion de tâches, rappels, priorités, habitudes et objectifs. Pensée mobile-first." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Flow Day Planner — Organisez vos journées" },
      { name: "twitter:description", content: "App intelligente de gestion de tâches, rappels, priorités, habitudes et objectifs. Pensée mobile-first." },
